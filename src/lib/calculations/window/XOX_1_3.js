// XOX-1/3 style的计算
export function calculateXOX_1_3(formData) {
    const {
        width,
        height,
        frame: frameType,
    ...
    if (frameType === 'nailon') {
        ...
        // Sash calculations
        result.sash = {
            width: roundToThree((w / 3 - 14.5 - 15 + 1) / 25.4),
        ...
        // Glass calculations
        const sashGlassW = w / 3 - 77 - 15;
        const sashGlassH = h - 109 - 15 * 2 - 3 - 2;
        const fixedGlassW = w / 3 - 41.4;
            ...
            if (gridType === 'Standard' && gridW && gridH) {
                ...
                result.grid = {
                    sash: {
                        ...
                        heightQuantity: (gridsquareW / 3 - 1) * 2,
                        widthHole: sashGridW / (gridsquareW / 3),
                    ...
                    fixed: {
                        ...
                        heightQuantity: gridsquareW / 3 - 1,
                        widthHole: fixedGridW / (gridsquareW / 3),
                        heightHole: 32
                    }
                };
        ...
        switch (glassType) {
            ...
            // Add other glass types (OBS/Lowe2, OBS/Lowe3, etc.)
        }
        ...
        // Sash calculations
        result.sash = {
            width: roundToThree((w / 3 - 14.5 + 1) / 25.4),
        ...
        if (frameType === 'block-slop') {
            result.parts.slop = roundToOne((w - 10) / 25.4);
        }

        // Glass calculations
        const sashGlassW = w / 3 - 77;
        ...
        // Grid calculations (similar to nailon frame)
        // ... (implement grid calculations for retrofit/block frames)
    }
